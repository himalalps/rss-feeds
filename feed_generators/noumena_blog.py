...
BASE_URL = "https://www.noumena.com"
...
def _search_nested_for_articles(data, depth=0):
    ...
    if isinstance(data, list) and data:
        ...
        for key in ("posts", "articles", "research", "items", "results", "data", "nodes", "edges"):
            if key in data:
...
def parse_noumena_html(html_content):
    """Parse the Noumena research HTML and extract articles using multiple strategies."""
    try:
...
def main(feed_name="noumena"):
    ...
    try:
        ...
        feed_config = {
            "title": "Noumena Research",
            "description": "Latest research from Noumena",
            "link": RESEARCH_URL,
            "language": "en",
            "author": {"name": "Noumena"},
